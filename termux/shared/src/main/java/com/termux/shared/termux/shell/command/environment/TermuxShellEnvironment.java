    ...
    public HashMap<String, String> getEnvironment(@NonNull Context currentPackageContext, boolean isFailSafe) {
        ...
        if (!isFailSafe) {
            ...
            if (TermuxBootstrap.isAppPackageVariantAPTAndroid5()) {
                ...
                StringBuilder fullPath = new StringBuilder(TermuxConstants.TERMUX_BIN_PREFIX_DIR_PATH);
                fullPath.append(":").append(TermuxConstants.TERMUX_HOME_DIR_PATH).append("/android-sdk/platform-tools");
                fullPath.append(":").append(TermuxConstants.TERMUX_HOME_DIR_PATH).append("/android-sdk/cmdline-tools/latest/bin");
                fullPath.append(":").append(TermuxConstants.TERMUX_PREFIX_DIR_PATH).append("/opt/flutter/bin");
                fullPath.append(":").append(TermuxConstants.TERMUX_PREFIX_DIR_PATH).append("/opt/flutter/bin/cache/dart-sdk/bin");
                fullPath.append(":").append(TermuxConstants.TERMUX_PREFIX_DIR_PATH).append("/opt/dart-sdk/bin");
                fullPath.append(":").append(TermuxConstants.TERMUX_HOME_DIR_PATH).append("/android-sdk/cmake/bin");
                fullPath.append(":/system/bin:/system/xbin");
                environment.put(ENV_PATH, fullPath.toString());
                environment.remove(ENV_LD_LIBRARY_PATH);
            }

            // Export standard toolchain environment variables
            environment.put("ANDROID_HOME", TermuxConstants.TERMUX_HOME_DIR_PATH + "/android-sdk");
            environment.put("ANDROID_SDK_ROOT", TermuxConstants.TERMUX_HOME_DIR_PATH + "/android-sdk");
            environment.put("JAVA_HOME", TermuxConstants.TERMUX_PREFIX_DIR_PATH + "/opt/openjdk");
            environment.put("NDK_HOME", TermuxConstants.TERMUX_HOME_DIR_PATH + "/android-sdk/ndk");
            environment.put("ANDROID_NDK_ROOT", TermuxConstants.TERMUX_HOME_DIR_PATH + "/android-sdk/ndk");
            environment.put("CMAKE_HOME", TermuxConstants.TERMUX_HOME_DIR_PATH + "/android-sdk/cmake");
            environment.put("FLUTTER_HOME", TermuxConstants.TERMUX_PREFIX_DIR_PATH + "/opt/flutter");
            environment.put("DART_HOME", TermuxConstants.TERMUX_PREFIX_DIR_PATH + "/opt/dart-sdk");
        }
