...
import com.aidenext.lsp.util.DocumentationReferenceProvider
import com.aidenext.progress.ProgressManager
import com.aidenext.utils.KeyboardUtils
  ...
  override fun setLayout(layout: CompletionLayout) {
    ...
    (layout.completionList as? ListView)?.let {
      ...
      it.setOnItemLongClickListener { _, view, position, _ ->
        val data =
          (items[position] as? com.aidenext.lsp.models.CompletionItem)?.data
