...
import com.aidenext.actions.EditorActionItem
import com.aidenext.actions.FillMenuParams
import com.aidenext.editor.R.layout
import com.aidenext.editor.databinding.LayoutPopupMenuItemBinding
import com.aidenext.editor.ui.EditorActionsMenu.ActionsListAdapter.VH
...
open class EditorActionsMenu(val editor: IDEEditor) :
  ...
  protected open fun onCreateActionData(): ActionData {
    ...
    data.put(com.aidenext.models.Range::class.java, editor.cursorLSPRange)
    data.put(
