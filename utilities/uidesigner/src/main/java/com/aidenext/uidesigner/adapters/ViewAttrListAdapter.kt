...
package com.aidenext.uidesigner.adapters
...
import com.aidenext.inflater.IView.SingleAttributeChangeListener
import com.aidenext.uidesigner.R
import com.aidenext.uidesigner.adapters.ViewAttrListAdapter.VH
import com.aidenext.uidesigner.databinding.LayoutViewattrItemBinding
...
internal class ViewAttrListAdapter(
  attributes: List<com.aidenext.inflater.IAttribute>,
  private val viewModel: WorkspaceViewModel?,
  private val onDeleteAttr: (com.aidenext.inflater.IAttribute) -> Boolean,
  private val onClick: (com.aidenext.inflater.IAttribute) -> Unit
