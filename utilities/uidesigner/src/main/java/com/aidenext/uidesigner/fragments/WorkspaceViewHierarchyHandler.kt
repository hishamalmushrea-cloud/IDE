...
import com.aidenext.uidesigner.undo.ViewAddedAction
import com.aidenext.uidesigner.undo.ViewMovedAction
import com.aidenext.uidesigner.undo.ViewRemovedAction
...
internal class WorkspaceViewHierarchyHandler :
  ...
  private fun pushAction(view: com.aidenext.inflater.IView,
  ...
  override fun beforeViewAdded(group: IViewGroup,
                               view: com.aidenext.inflater.IView,
                               index: Int
  ) {
    animateLayoutChange()
  }
