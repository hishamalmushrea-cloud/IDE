...
package com.aidenext.uidesigner.views
...
constructor(
  ...
  private fun addViews(view: IView, depth: Int) {
    ...
    if (view is com.aidenext.inflater.IViewGroup) {
  ...
  private fun computeChildCount(view: com.aidenext.inflater.IViewGroup): Int {
    var count = view.childCount
    view.forEachIndexed { index, child ->
      if (index != view.childCount - 1 && child is com.aidenext.inflater.IViewGroup) {
