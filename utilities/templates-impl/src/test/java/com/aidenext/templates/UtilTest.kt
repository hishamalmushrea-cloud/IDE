...
import com.aidenext.templates.ParameterConstraint.CLASS
import com.aidenext.templates.ParameterConstraint.CLASS_NAME
import com.aidenext.templates.ParameterConstraint.DIRECTORY
import com.aidenext.templates.ParameterConstraint.EXISTS
import com.aidenext.templates.ParameterConstraint.FILE
import com.aidenext.templates.ParameterConstraint.LAYOUT
import com.aidenext.templates.ParameterConstraint.MODULE_NAME
import com.aidenext.templates.ParameterConstraint.NONEMPTY
import com.aidenext.templates.ParameterConstraint.PACKAGE
import com.aidenext.templates.base.util.isValidModuleName
import com.aidenext.templates.base.util.moduleNameToDirName
import com.aidenext.templates.impl.ConstraintVerifier
...
class UtilTest {
  ...
  fun `test constraint verifier`() {
    ConstraintVerifier.apply {
      ...
      assertThat(isValid("com.aidenext", listOf(PACKAGE))).isTrue()
