...
import com.aidenext.templates.SrcSet
import com.aidenext.templates.TemplateBuilder
import com.aidenext.templates.TemplateRecipeConfigurator
import com.aidenext.templates.TemplateRecipeFinalizer
import com.aidenext.templates.base.models.Dependency
import com.aidenext.templates.base.models.defaultDependency
...
abstract class ModuleTemplateBuilder :
   ...
   * @see com.aidenext.templates.base.baseAsset
   */
  open fun baseAsset(path: String) =
    com.aidenext.templates.base.util.baseAsset("module", path)
   ...
   * [Implementation][com.aidenext.templates.base.models.DependencyConfiguration.Implementation]
   * configuration.
   *
