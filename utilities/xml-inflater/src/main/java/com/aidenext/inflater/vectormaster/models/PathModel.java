...
package com.aidenext.inflater.vectormaster.models;
...
import com.aidenext.inflater.vectormaster.DefaultValues;
import com.aidenext.inflater.vectormaster.utilities.Utils;
import com.aidenext.inflater.vectormaster.utilities.parser.PathParser;
...
public class PathModel {
  ...
  public void buildPath(boolean useLegacyParser) {
    if (useLegacyParser) {
      originalPath =
          com.aidenext.inflater.vectormaster.utilities.legacyparser.PathParser.createPathFromPathData(
              pathData);
    } else {
