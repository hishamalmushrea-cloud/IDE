...
import com.aidenext.annotations.inflater.ViewAdapter
import com.aidenext.annotations.uidesigner.IncludeInDesigner
import com.aidenext.annotations.uidesigner.IncludeInDesigner.Group.WIDGETS
import com.aidenext.inflater.AttributeHandlerScope
import com.aidenext.inflater.IAttribute
import com.aidenext.inflater.INamespace
import com.aidenext.inflater.IView
import com.aidenext.inflater.IViewAdapter
import com.aidenext.inflater.internal.IncludeView
import com.aidenext.inflater.models.UiWidget
import com.aidenext.inflater.utils.newAttribute
...
open class ViewAdapter<T : View> : IViewAdapter<T>() {
  ...
  protected open fun parseDrawingCacheQuality(value: String): Int {
    return com.aidenext.inflater.internal.utils.parseDrawingCacheQuality(value)
  }

  protected open fun parseVisibility(value: String): Int {
    return com.aidenext.inflater.internal.utils.parseVisibility(value)
  }

  protected open fun parseTextAlignment(value: String): Int {
    return com.aidenext.inflater.internal.utils.parseTextAlignment(value)
  }

  protected open fun parseTextDirection(value: String): Int {
    return com.aidenext.inflater.internal.utils.parseTextDirection(value)
  }

  protected open fun parsePorterDuffMode(mode: String): PorterDuff.Mode {
    return com.aidenext.inflater.internal.utils.parsePorterDuffMode(mode)
  }
