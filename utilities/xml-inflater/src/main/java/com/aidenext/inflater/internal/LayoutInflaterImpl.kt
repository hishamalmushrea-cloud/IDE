...
package com.aidenext.inflater.internal
...
import com.aidenext.inflater.DefaultComponentFactory
import com.aidenext.inflater.IAttribute
import com.aidenext.inflater.IComponentFactory
import com.aidenext.inflater.IComponentFactory.Companion.LAYOUT_INFLATER_COMPONENT_FACTORY_KEY
import com.aidenext.inflater.ILayoutInflater
import com.aidenext.inflater.INamespace
import com.aidenext.inflater.IView
import com.aidenext.inflater.IViewGroup
import com.aidenext.inflater.InflateException
import com.aidenext.inflater.events.IInflateEventsListener
import com.aidenext.inflater.events.InflationFinishEvent
import com.aidenext.inflater.events.InflationStartEvent
import com.aidenext.inflater.events.OnApplyAttributeEvent
import com.aidenext.inflater.events.OnInflateViewEvent
import com.aidenext.inflater.internal.utils.IDTable
import com.aidenext.inflater.internal.utils.ViewFactory.createViewInstance
import com.aidenext.inflater.internal.utils.ViewFactory.generateLayoutParams
import com.aidenext.inflater.internal.utils.parseLayoutReference
import com.aidenext.inflater.utils.endParse
import com.aidenext.inflater.utils.isParsing
import com.aidenext.inflater.utils.startParse
import com.aidenext.inflater.viewAdapter
import com.aidenext.lookup.Lookup
import com.aidenext.projects.android.AndroidModule
import com.aidenext.xml.widgets.Widget
import com.aidenext.xml.widgets.WidgetTable
import com.aidenext.xml.widgets.WidgetType
import java.io.File
...
open class LayoutInflaterImpl : ILayoutInflater {
  ...
  protected open fun processXmlFile(file: File): Pair<XmlProcessor, AndroidModule> {
    return com.aidenext.inflater.utils.processXmlFile(file, LAYOUT)
  }
  ...
  private fun startInflation(file: File) {
    ...
    if (!isParsing) {
      if (this.module == null) {
        startParse(file)
        this.module = com.aidenext.inflater.utils.module
      } else {
