 ...
 * - [ViewAdapter][com.aidenext.annotations.inflater.ViewAdapter] is used to specify the
 *   view whose attributes are handled by the view adapter implementation.
 * - [IncludeInDesigner][com.aidenext.annotations.uidesigner.IncludeInDesigner] is used to
...
abstract class IViewAdapter<T : View> : AbstractParser() {
   ...
   * [ViewAdapter][com.aidenext.annotations.inflater.ViewAdapter] annotation.
   *
