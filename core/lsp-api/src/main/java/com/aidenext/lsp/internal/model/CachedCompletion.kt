...
package com.aidenext.lsp.internal.model
...
private constructor(
  ...
  val result: com.aidenext.lsp.models.CompletionResult
) {
  ...
  companion object {
    ...
    val EMPTY =
      cache(
        CompletionParams(
          com.aidenext.models.Position.NONE,
          Paths.get(""), ICancelChecker.CANCELLED
        ),
        com.aidenext.lsp.models.CompletionResult.EMPTY
      )
    ...
    fun cache(
      ...
      result: com.aidenext.lsp.models.CompletionResult
    ): CachedCompletion {
      val params =
