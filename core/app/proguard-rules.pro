...
# Tooling API classes
-keep class com.aidenext.tooling.** { *; }

# Builder model implementations
-keep class com.aidenext.builder.model.** { *; }
...
-keep class com.aidenext.projects.util.StringSearch {
    packageName(java.nio.file.Path);
}
-keep class * implements org.antlr.v4.runtime.Lexer {
    <init>(...);
}
-keep class * extends com.aidenext.lsp.java.providers.completion.IJavaCompletionProvider {
    <init>(...);
}
-keep class com.aidenext.editor.api.IEditor { *; }
-keep class * extends com.aidenext.inflater.IViewAdapter { *; }
-keep class * extends com.aidenext.inflater.drawable.IDrawableParser {
    <init>(...);
    android.graphics.drawable.Drawable parse();
    android.graphics.drawable.Drawable parseDrawable();
}
-keep class com.aidenext.utils.DialogUtils {  public <methods>; }

# APK Metadata
-keep class com.aidenext.models.ApkMetadata { *; }
-keep class com.aidenext.models.ArtifactType { *; }
-keep class com.aidenext.models.MetadataElement { *; }
...
-keep enum com.aidenext.xml.permissions.Permission { *; }
...
-keep class com.aidenext.treesitter.** { *; }
...
## Themes
-keep enum com.aidenext.ui.themes.IDETheme {
  *;
}

## Contributor models - deserialized with GSON
-keep class * implements com.aidenext.contributors.Contributor {
  *;
}
