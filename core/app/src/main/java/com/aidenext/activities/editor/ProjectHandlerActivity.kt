...
import com.aidenext.databinding.LayoutSearchProjectBinding
import com.aidenext.flashbar.Flashbar
import com.aidenext.fragments.sheets.ProgressSheet
import com.aidenext.handlers.EditorBuildEventListener
import com.aidenext.handlers.LspHandler.connectClient
import com.aidenext.handlers.LspHandler.destroyLanguageServers
...
import com.aidenext.services.builder.GradleBuildServiceConnnection
import com.aidenext.services.builder.gradleDistributionParams
import com.aidenext.tasks.executeAsyncProvideError
import com.aidenext.tasks.executeWithProgress
import com.aidenext.tooling.api.messages.AndroidInitializationParams
...
import com.aidenext.tooling.api.models.BuildVariantInfo
import com.aidenext.tooling.api.models.mapToSelectedVariants
import com.aidenext.utils.DURATION_INDEFINITE
import com.aidenext.utils.DialogUtils.newMaterialDialogBuilder
import com.aidenext.utils.RecursiveFileSearcher
import com.aidenext.utils.flashError
import com.aidenext.utils.flashbarBuilder
import com.aidenext.utils.resolveAttr
import com.aidenext.utils.showOnUiThread
import com.aidenext.utils.withIcon
import com.aidenext.viewmodel.BuildVariantsViewModel
  ...
  fun initializeProject(buildVariantsProvider: () -> Map<String, String>) {
    executeWithProgress { progress ->
      executeAsyncProvideError(buildVariantsProvider::invoke) { result, error ->
        com.aidenext.tasks.runOnUiThread {
          progress.dismiss()
        }
