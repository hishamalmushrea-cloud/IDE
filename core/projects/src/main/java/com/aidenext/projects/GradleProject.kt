...
/**
 * A Gradle project model which is identical to [IGradleProject][com.aidenext.tooling.api.IGradleProject]. This project module caches all the data
 * from an [IGradleProject][com.aidenext.tooling.api.IGradleProject] eliminating the use of [CompletableFuture] s.
 *
