...
import com.aidenext.lsp.java.models.DiagnosticCode.EMPTY_BLOCK
import com.aidenext.lsp.java.models.DiagnosticCode.UNUSED_THROWS
import com.aidenext.lsp.java.visitors.DiagnosticVisitor
import com.aidenext.lsp.models.DiagnosticItem
import com.aidenext.lsp.models.DiagnosticSeverity
import com.aidenext.lsp.models.DiagnosticSeverity.WARNING
...
import com.aidenext.utils.DocumentUtils.isSameFile
...
object DiagnosticsProvider {
  ...
  private fun getPosition(position: Long, lines: LineMap): com.aidenext.models.Position {
    abortIfCancelled()
    ...
    return com.aidenext.models.Position(line, column)
  }
