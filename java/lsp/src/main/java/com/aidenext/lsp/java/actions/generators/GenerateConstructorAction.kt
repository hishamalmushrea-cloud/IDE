...
import com.aidenext.lsp.java.actions.FieldBasedAction
import com.aidenext.lsp.java.compiler.CompileTask
import com.aidenext.lsp.java.utils.EditHelper
import com.aidenext.lsp.java.utils.ShortTypePrinter.NO_PACKAGE
...
class GenerateConstructorAction : FieldBasedAction() {
  ...
  private fun generateForFields(
    ...
    val stopWatch = com.aidenext.utils.StopWatch("generateConstructorForFields()")
    val constructor =
