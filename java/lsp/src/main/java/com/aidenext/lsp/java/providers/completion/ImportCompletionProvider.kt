...
import com.aidenext.lsp.java.providers.CompletionProvider.MAX_COMPLETION_ITEMS
...
import com.aidenext.utils.ClassTrie.Node
...
class ImportCompletionProvider(
   ...
   */
  private fun collectPackageNode(trie: com.aidenext.utils.ClassTrie, pkgName: String): Node? {
