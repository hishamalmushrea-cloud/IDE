...
package com.aidenext.lsp.java.edits
...
class MultipleClassImportEditHandler(
  ...
  override fun performEdits(
    ...
    editor: CodeEditor,
    completionItem: com.aidenext.lsp.models.CompletionItem
  ) {
    val edits = mutableListOf<com.aidenext.lsp.models.TextEdit>()
    ...
    com.aidenext.lsp.util.RewriteHelper.performEdits(edits, editor)
  }
}
