...
import com.aidenext.lsp.java.rewrite.ImplementAbstractMethods
...
class ImplementAbstractMethodsAction : BaseJavaCodeAction() {
  ...
  override fun prepare(data: ActionData) {
    ...
    if (!data.hasRequiredData(com.aidenext.lsp.models.DiagnosticItem::class.java)) {
      markInvisible()
      return
    }

    val diagnostic = data.get(com.aidenext.lsp.models.DiagnosticItem::class.java)!!
  ...
  override suspend fun execAction(data: ActionData): Any {
    val diagnostic =
      JavaDiagnosticUtils.asJCDiagnostic(
        data.get(
          com.aidenext.lsp.models.DiagnosticItem::class.java)!!.extra as Diagnostic<out JavaFileObject>
      )
