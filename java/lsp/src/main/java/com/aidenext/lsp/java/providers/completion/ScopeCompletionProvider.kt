...
import com.aidenext.lsp.java.edits.MultipleClassImportEditHandler
import com.aidenext.lsp.java.models.JavaCompletionItem
import com.aidenext.lsp.java.utils.JavaPoetUtils.Companion.buildMethod
import com.aidenext.lsp.java.utils.JavaPoetUtils.Companion.print
import com.aidenext.lsp.java.utils.ScopeHelper
...
class ScopeCompletionProvider(
  ...
  private fun overrideIfPossible(
    ...
    item.completionKind = com.aidenext.lsp.models.CompletionItemKind.METHOD
