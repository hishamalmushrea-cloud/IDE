...
package com.aidenext.tooling.api.models.result

/**
 * Result sent to the client when selecting a project in [IProjectQueries][com.aidenext.tooling.api.IProjectQueries].
 *
