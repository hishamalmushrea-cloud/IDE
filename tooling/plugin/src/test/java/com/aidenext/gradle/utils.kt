...
import com.aidenext.tooling.api.LogSenderConfig._PROPERTY_IS_TEST_ENV
import com.aidenext.tooling.api.LogSenderConfig._PROPERTY_MAVEN_LOCAL_REPOSITORY
...
internal fun writeInitScript(file: File, deps: List<File>) {
  ...
  file.bufferedWriter().use {
    it.write(
      ...
      apply plugin: com.aidenext.gradle.AndroidIDEInitScriptPlugin
    """.trimIndent()
    )
  }
}
