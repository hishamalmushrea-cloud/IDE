...
package com.aidenext.tooling.impl
...
import com.aidenext.tooling.api.messages.GradleDistributionParams
import com.aidenext.tooling.api.messages.GradleDistributionType
import com.aidenext.tooling.api.messages.InitializeProjectParams
import com.aidenext.tooling.api.messages.TaskExecutionMessage
import com.aidenext.tooling.api.messages.result.BuildCancellationRequestResult
import com.aidenext.tooling.api.messages.result.BuildCancellationRequestResult.Reason.CANCELLATION_ERROR
import com.aidenext.tooling.api.messages.result.BuildInfo
import com.aidenext.tooling.api.messages.result.BuildResult
import com.aidenext.tooling.api.messages.result.InitializeResult
import com.aidenext.tooling.api.messages.result.TaskExecutionResult
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_CANCELLED
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.BUILD_FAILED
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_CLOSED
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.CONNECTION_ERROR
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_DIRECTORY_INACCESSIBLE
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_DIRECTORY
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_FOUND
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.PROJECT_NOT_INITIALIZED
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.UNKNOWN
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_BUILD_ARGUMENT
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_CONFIGURATION
import com.aidenext.tooling.api.messages.result.TaskExecutionResult.Failure.UNSUPPORTED_GRADLE_VERSION
import com.aidenext.tooling.api.models.ToolingServerMetadata
import com.aidenext.tooling.impl.internal.ProjectImpl
import com.aidenext.tooling.impl.sync.ModelBuilderException
import com.aidenext.tooling.impl.sync.RootModelBuilder
import com.aidenext.tooling.impl.sync.RootProjectModelBuilderParams
...
internal class ToolingApiServerImpl(private val project: ProjectImpl) :
  ...
  override fun shutdown(): CompletableFuture<Void> {
    return CompletableFuture.supplyAsync {
      ...
      // see com.aidenext.tooling.impl.Main.main(String[])
