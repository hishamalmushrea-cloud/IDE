...
import com.aidenext.desugaring.internal.parsing.InsnLexer
import com.aidenext.desugaring.internal.parsing.InsnParser
import com.aidenext.desugaring.internal.parsing.InsnParser.ParseException
...
class InsnParserTest {
  ...
  fun `test simple instruction parse`() {
    ...
    assertThat(insn.toClass).isEqualTo(
      "com.aidenext.desugaring.sample.java.io.DesugaredInputStream")
  ...
  """.trimIndent()
    ...
    insns[1].also { insn ->
      ...
      assertThat(insn.toOpcode).isEqualTo(MethodOpcode.INVOKESTATIC)
      assertThat(insn.toClass).isEqualTo(
        "com.aidenext.desugaring.sample.java.util.DesugaredMath")
